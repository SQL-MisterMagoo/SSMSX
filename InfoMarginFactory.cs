//------------------------------------------------------------------------------
// <copyright file="InfoMarginFactory.cs" company="Company">
...
namespace SSMSX
{
    ...
    [ContentType("sql")]                                       // Show this margin for all text-based types
    [TextViewRole(PredefinedTextViewRoles.Interactive)]
    internal sealed class InfoMarginFactory : IWpfTextViewMarginProvider
    {
